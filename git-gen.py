...
def arguments(argsval):
    ...
    parser.add_argument('-un', '--user_name', type=str, required=False, default="alex-soft-dev",
                        help="""Overrides user.name git config.
                        If not specified, the global config is used.""")
    parser.add_argument('-ue', '--user_email', type=str, required=False, default="info@alex-soft.com",
    ...
    parser.add_argument('-sd', '--start_date', type=str, required=False, default='2024/01/17, 20:00:00',
                        help="""Start Date.""")
